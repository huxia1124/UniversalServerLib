...
/* Standard interface: UniversalServerRPC, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO UniversalServerRPC_ProxyInfo;
    ...
    /* [string][in] */ const WCHAR *szScriptFile)
{
    ...
    NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&UniversalServerRPC_ProxyInfo,
                  0,
                  0,
                  IDL_handle,
                  szScriptFile);
...
static const MIDL_STUB_DESC UniversalServerRPC_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& UniversalServerRPC_ProxyInfo,   /* proxy/server info */
    0
    };
...
static const MIDL_STUBLESS_PROXY_INFO UniversalServerRPC_ProxyInfo =
    {
